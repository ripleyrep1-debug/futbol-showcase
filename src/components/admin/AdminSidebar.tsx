...
import { LayoutDashboard, Users, Trophy, CreditCard, Settings, LogOut, ChevronLeft, ChevronRight } from "lucide-react";
...
const AdminSidebar = () => {
  ...
  return (
    <aside
      className={`sticky top-0 h-screen flex flex-col border-r border-border bg-card transition-all duration-300 ${
        collapsed ? "w-16" : "w-60"
      }`}
    >
      {/* Logo */}
